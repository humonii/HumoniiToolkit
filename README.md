...
Tailscale 接続済みなら自動検出、またはコンテナが起動中なら `http://127.0.0.1:8501/streamlit/` でアクセスします。
...
- `https://humonii.github.io/HumoniiToolkit/?streamlit_url=http://192.168.1.100:8501/streamlit/`
